...
typedef enum {
    UNI_NET_FTP_CLIENT_DISCONNECT_REASON_UNKNOWN      = 0,
    UNI_NET_FTP_CLIENT_DISCONNECT_REASON_RESPONSE_ERR = 1,
    UNI_NET_FTP_CLIENT_DISCONNECT_REASON_WRONG_DATA   = 2,
    UNI_NET_FTP_CLIENT_DISCONNECT_REASON_WRONG_CMD    = 3,
    UNI_NET_FTP_CLIENT_DISCONNECT_REASON_MEMORY_ALLOC = 4,
    UNI_NET_FTP_CLIENT_DISCONNECT_REASON_NO_BYTES     = 5,
    UNI_NET_FTP_CLIENT_DISCONNECT_REASON_TERMINATION  = 6,
    UNI_NET_FTP_CLIENT_DISCONNECT_REASON_CONNECT      = 7,
    UNI_NET_FTP_CLIENT_DISCONNECT_REASON_NETWORK      = 8,
    UNI_NET_FTP_CLIENT_DISCONNECT_REASON_SOCKET       = 9,
} uni_net_ftp_client_disconnect_reason_e;
